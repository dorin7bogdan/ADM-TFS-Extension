    ...
    public class InvokeAlmLabManagementStopTaskCmdlet : AbstractLauncherTaskCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                {
                    kvFilePath = Path.Combine(resDir, C._RANDOM_KEY_TMP);
                    ...
                    if (jobStatus.EqualsIgnoreCase(C.Canceled))
                    {
                        ...
                        else
                        {
                            ...
                            if (File.Exists(propsFilePath))
                            {
                                ...
                                if (DoStopLastRun(lastRunId, ciParams, resDir))
                                {
        ...
        private bool DoStopLastRun(string runId, JavaProperties ciParams, string resDir)
        {
            ...
            H.ApplyPrivateKeyFromFile(resDir);
