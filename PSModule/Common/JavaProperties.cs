...
namespace PSModule.Common
{
    ...
    {
        public bool NotSupportedFileBOM { get; private set; } = false;
        ...
        private void LoadInternal(LineReader lr)
        {
            ...
            NotSupportedFileBOM = lr.NotSupportedFileBOM;
        }
        ...
        private class LineReader
        {
            ...
            private static readonly byte[] UTF32BEBOM = [0, 0, 0xFE, 0xFF];
            private static readonly byte[] UTF32LEBOM = [0xFF, 0xFE, 0, 0];
                                   ...
                                   bool escapeUnicode)
        {
            ...
            StringBuilder outBuffer = new(bufLen);
        ...
        {
            using StreamWriter wr = new(fullpath, false, Encoding.GetEncoding("ISO-8859-1"));
